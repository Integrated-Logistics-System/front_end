...
import { Eye, EyeOff, ChefHat, UtensilsCrossed, Clock, Users, Sparkles, Heart, Shield, Zap } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-950 via-amber-950 to-red-950 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-b from-black/20 to-black/40">
        <div className="w-full max-w-md">
          ...
          <div className="bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-sm p-8 rounded-2xl border border-orange-500/30 shadow-2xl">
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-amber-900/30 to-orange-900/30 rounded-xl border border-amber-500/30">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-sm font-medium text-amber-300">체험용 셰프 계정</p>
              </div>
              <div className="text-sm text-amber-200 space-y-1">
                <div className="flex items-center gap-2">
                  <Sparkles className="h-3 w-3" />
                  <span>이메일: demo@example.com</span>
                </div>
                <div className="flex items-center gap-2">
                  <Shield className="h-3 w-3" />
                  <span>비밀번호: demo123</span>
                </div>
              </div>
            </div>
